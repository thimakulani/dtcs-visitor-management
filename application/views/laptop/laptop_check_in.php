		...
		<div class="login-box">
			<div class="card">
				...
				<div class="card-body login-card-body">
					...
					<form method="post" action="<?php echo base_url();?>laptop/process_persal">
						<div class="text-danger"><?php echo $error?></div>
						<div class="input-group mb-3">
							<input type="number" name="Percal" value="<?php echo set_value('Percal')?>" class="form-control" placeholder="Percal Number or Id Number">
